new Vue({
	...
	data: {
		...
		info: {
			...
			profession_description1: "💻 Ingeniero en Informática",
			profession_description2: "💻 Desarrollador Web Fullstack",
		...
		social: [
			...
			},
			{
				...
				description:
					"En este espacio genero contenido de valor dando mi opinión en base a mi experiencia acerca de temas de tecnología y marketing digital.",
				icon: "fa fa-font",
				color: "background:#007BB5; color: #fff; text-shadow: 0px 0px 10px rgba(0,0,0,0.5);",
				show_description: false,
			},
			{
				...
				description:
					"En este espacio podrás acceder a mi perfil profesional.",
				icon: "fa fa-linkedin",
			...
			},
			{
				...
				description:
					"Lograrás acceder a mis proyectos terminados y en los que me encuentro desarrollando en el área de sistemas.",
			...
			},
			{
				...
				description:
					"En este espacio encontraras mi lado autodidacta de aprendizaje y contribución en base a conocimientos aprendidos sobre programación.",
			...
			},
			{
				...
				description:
					"En este espacio creo y/o comparto contenido de valor relacionado a lo que esta sucediendo actualmente en el área de tecnológica.",
				icon: "fa fa-twitter",
			...
			},
			{
				...
				description:
					"En este espacio comparto contenido variado desde mis hobbies, proyectos personales, viajes, música entre otros.",
			...
			},
			{
				...
				description:
					"En este espacio comparto contenido variado del mundo de la tecnología.",
				icon: "fab fa-tiktok",
				color: "background:#000; color:#fff; text-shadow: 0px 0px 10px rgba(0,0,0,0.5);",
				show_description: false,
			},
			{
				...
				description:
					"En este espacio comparto contenido relacionado a proyectos que he realizado o que he contribuido en base a desarrollo front-end (diseños) y marketing digital.",
				icon: "fa fa-behance",
				color: "background:#000; color:#fff; text-shadow: 0px 0px 10px rgba(0,0,0,0.5);",
				show_description: false,
			},
			{
				...
				description:
					"En este espacio verás parte de mi lado competitivo, autodidacta en el área de la programación.",
			...
			},
			{
				...
				description:
					"En este espacio verás aportes, ejemplos, tutoriales, contenido relacionados a la tecnología y como ser mejor programador.",
				icon: "fab fa-youtube",
